...
public class RichMahogany4Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:rich_mahogany_4")
	public static final Block block = null;
	public RichMahogany4Block(TerariamodModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("rich_mahogany_4");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(RichMahogany4Block.block, (int) (1));
		}
