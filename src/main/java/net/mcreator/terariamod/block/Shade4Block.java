...
import net.mcreator.terariamod.procedures.PearldropProcedure;
...
public class Shade4Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:shade_4")
	public static final Block block = null;
	public Shade4Block(TerariamodModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Shade4Block.block, (int) (1));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				PearldropProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
