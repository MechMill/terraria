...
public class Pearl3Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:pearl_3")
	public static final Block block = null;
	public Pearl3Block(TerariamodModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Pearl3Block.block, (int) (1));
		}
