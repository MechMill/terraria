...
public class HardenedEbonsandBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:hardened_ebonsand")
	public static final Block block = null;
	public HardenedEbonsandBlock(TerariamodModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hardened_ebonsand");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(HardenedEbonsandBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HardenedEbonsandBlock.block, (int) (1)));
		}
	}
}
