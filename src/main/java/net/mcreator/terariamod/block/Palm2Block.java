...
import net.mcreator.terariamod.procedures.PalmdropProcedure;
...
public class Palm2Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:palm_2")
	public static final Block block = null;
	public Palm2Block(TerariamodModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Palm2Block.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PalmWoodBlock.block, (int) (1)));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				PalmdropProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
