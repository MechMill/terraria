...
public class EbonsandBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:ebonsand")
	public static final Block block = null;
	public EbonsandBlock(TerariamodModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ebonsand");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(EbonsandBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EbonsandBlock.block, (int) (1)));
		}
	}
}
