...
public class TreeBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:tree")
	public static final Block block = null;
	public TreeBlock(TerariamodModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(TreeBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TreeBlock.block, (int) (1)));
		}
	}
}
