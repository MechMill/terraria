...
public class MarbleBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:marble")
	public static final Block block = null;
	public MarbleBlock(TerariamodModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(MarbleBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MarbleBlock.block, (int) (1)));
		}
	}
}
