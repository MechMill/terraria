...
public class Palm3Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:palm_3")
	public static final Block block = null;
	public Palm3Block(TerariamodModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Palm3Block.block, (int) (1));
		}
