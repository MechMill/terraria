...
public class CrimsandBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:crimsand")
	public static final Block block = null;
	public CrimsandBlock(TerariamodModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crimsand");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CrimsandBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrimsandBlock.block, (int) (1)));
		}
	}
}
