...
public class Boreal4Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:boreal_4")
	public static final Block block = null;
	public Boreal4Block(TerariamodModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Boreal4Block.block, (int) (1));
		}
