...
public class SiltBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:silt")
	public static final Block block = null;
	public SiltBlock(TerariamodModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SiltBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SiltBlock.block, (int) (1)));
		}
	}
}
