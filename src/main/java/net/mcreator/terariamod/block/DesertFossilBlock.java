...
public class DesertFossilBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:desert_fossil")
	public static final Block block = null;
	public DesertFossilBlock(TerariamodModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("desert_fossil");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(DesertFossilBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DesertFossilBlock.block, (int) (1)));
		}
	}
}
