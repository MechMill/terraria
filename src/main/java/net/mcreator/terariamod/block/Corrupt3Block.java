...
public class Corrupt3Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:corrupt_3")
	public static final Block block = null;
	public Corrupt3Block(TerariamodModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Corrupt3Block.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EbonWoodBlock.block, (int) (2)));
		}
