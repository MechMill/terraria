...
public class Shade3Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:shade_3")
	public static final Block block = null;
	public Shade3Block(TerariamodModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Shade3Block.block, (int) (1));
		}
