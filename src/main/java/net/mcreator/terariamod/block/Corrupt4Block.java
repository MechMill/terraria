...
public class Corrupt4Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:corrupt_4")
	public static final Block block = null;
	public Corrupt4Block(TerariamodModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Corrupt4Block.block, (int) (1));
		}
