...
public class EbonsandstoneBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:ebonsandstone")
	public static final Block block = null;
	public EbonsandstoneBlock(TerariamodModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ebonsandstone");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(EbonsandstoneBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EbonsandstoneBlock.block, (int) (1)));
		}
	}
}
