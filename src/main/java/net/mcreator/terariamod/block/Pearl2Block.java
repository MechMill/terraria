...
public class Pearl2Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:pearl_2")
	public static final Block block = null;
	public Pearl2Block(TerariamodModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Pearl2Block.block, (int) (1));
		}
