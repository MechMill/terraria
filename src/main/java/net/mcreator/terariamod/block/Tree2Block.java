...
public class Tree2Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:tree_2")
	public static final Block block = null;
	public Tree2Block(TerariamodModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Tree2Block.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Tree2Block.block, (int) (1)));
		}
	}
}
