...
public class HardenedSandBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:hardened_sand")
	public static final Block block = null;
	public HardenedSandBlock(TerariamodModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(HardenedSandBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HardenedSandBlock.block, (int) (1)));
		}
	}
}
