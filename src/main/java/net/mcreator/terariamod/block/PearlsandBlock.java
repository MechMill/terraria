...
public class PearlsandBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:pearlsand")
	public static final Block block = null;
	public PearlsandBlock(TerariamodModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pearlsand");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PearlsandBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PearlsandBlock.block, (int) (1)));
		}
	}
}
