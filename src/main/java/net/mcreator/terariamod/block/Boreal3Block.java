...
import net.mcreator.terariamod.procedures.BorealdropProcedure;
...
public class Boreal3Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:boreal_3")
	public static final Block block = null;
	public Boreal3Block(TerariamodModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Boreal3Block.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BorealWoodBlock.block, (int) (2)));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BorealdropProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
