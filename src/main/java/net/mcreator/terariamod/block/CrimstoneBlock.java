...
public class CrimstoneBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:crimstone")
	public static final Block block = null;
	public CrimstoneBlock(TerariamodModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CrimstoneBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrimstoneBlock.block, (int) (1)));
		}
	}
}
