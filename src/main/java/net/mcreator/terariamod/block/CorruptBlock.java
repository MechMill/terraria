...
public class CorruptBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:corrupt")
	public static final Block block = null;
	public CorruptBlock(TerariamodModElements instance) {
		super(instance, 57);
	}
