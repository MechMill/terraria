...
public class Corrupt2Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:corrupt_2")
	public static final Block block = null;
	public Corrupt2Block(TerariamodModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Corrupt2Block.block, (int) (1));
		}
