...
public class PearlsandstoneBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:pearlsandstone")
	public static final Block block = null;
	public PearlsandstoneBlock(TerariamodModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pearlsandstone");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PearlsandstoneBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PearlsandstoneBlock.block, (int) (1)));
		}
	}
}
