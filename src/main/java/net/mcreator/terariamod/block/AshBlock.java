...
public class AshBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:ash")
	public static final Block block = null;
	public AshBlock(TerariamodModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(AshBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AshBlock.block, (int) (1)));
		}
	}
}
