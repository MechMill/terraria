...
public class GraniteBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:granite")
	public static final Block block = null;
	public GraniteBlock(TerariamodModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granite");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(GraniteBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GraniteBlock.block, (int) (1)));
		}
	}
}
