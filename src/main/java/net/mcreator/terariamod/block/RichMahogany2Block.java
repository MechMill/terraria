...
import net.mcreator.terariamod.procedures.RichMahoganydropProcedure;
...
public class RichMahogany2Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:rich_mahogany_2")
	public static final Block block = null;
	public RichMahogany2Block(TerariamodModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rich_mahogany_2");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(RichMahogany2Block.block, (int) (1));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				RichMahoganydropProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
