...
public class CrimsandstoneBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:crimsandstone")
	public static final Block block = null;
	public CrimsandstoneBlock(TerariamodModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crimsandstone");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CrimsandstoneBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrimsandstoneBlock.block, (int) (1)));
		}
	}
}
