...
public class SandstoneBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:sandstone")
	public static final Block block = null;
	public SandstoneBlock(TerariamodModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SandstoneBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SandstoneBlock.block, (int) (1)));
		}
	}
}
