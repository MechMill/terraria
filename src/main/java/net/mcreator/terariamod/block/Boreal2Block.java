...
public class Boreal2Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:boreal_2")
	public static final Block block = null;
	public Boreal2Block(TerariamodModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Boreal2Block.block, (int) (1));
		}
