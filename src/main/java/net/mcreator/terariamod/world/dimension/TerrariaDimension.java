...
package net.mcreator.terariamod.world.dimension;
...
import net.mcreator.terariamod.block.StoneBlock;
...
public class TerrariaDimension extends TerariamodModElements.ModElement {
	public TerrariaDimension(TerariamodModElements instance) {
		super(instance, 25);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("terariamod:terraria"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
