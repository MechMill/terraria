...
public class PalmWoodBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:palm_wood")
	public static final Block block = null;
	public PalmWoodBlock(TerariamodModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PalmWoodBlock.block, (int) (1));
		}
