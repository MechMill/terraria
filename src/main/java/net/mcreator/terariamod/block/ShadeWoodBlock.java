...
public class ShadeWoodBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:shade_wood")
	public static final Block block = null;
	public ShadeWoodBlock(TerariamodModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("shade_wood");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(ShadeWoodBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ShadeWoodBlock.block, (int) (1)));
		}
	}
}
