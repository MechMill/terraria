...
public class Mushrooms4Block extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:mushrooms_4")
	public static final Block block = null;
	public Mushrooms4Block(TerariamodModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Mushrooms4Block.block, (int) (1));
		}
