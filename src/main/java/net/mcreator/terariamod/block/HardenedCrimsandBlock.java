...
public class HardenedCrimsandBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:hardened_crimsand")
	public static final Block block = null;
	public HardenedCrimsandBlock(TerariamodModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hardened_crimsand");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(HardenedCrimsandBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HardenedCrimsandBlock.block, (int) (1)));
		}
	}
}
