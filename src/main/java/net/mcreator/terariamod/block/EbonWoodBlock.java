...
public class EbonWoodBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:ebon_wood")
	public static final Block block = null;
	public EbonWoodBlock(TerariamodModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ebon_wood");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(EbonWoodBlock.block, (int) (1));
		}
