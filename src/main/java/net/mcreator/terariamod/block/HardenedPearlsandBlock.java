...
public class HardenedPearlsandBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:hardened_pearlsand")
	public static final Block block = null;
	public HardenedPearlsandBlock(TerariamodModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hardened_pearlsand");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(HardenedPearlsandBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HardenedPearlsandBlock.block, (int) (1)));
		}
	}
}
