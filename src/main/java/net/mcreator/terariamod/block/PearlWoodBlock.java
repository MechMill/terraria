...
public class PearlWoodBlock extends TerariamodModElements.ModElement {
	@ObjectHolder("terariamod:pearl_wood")
	public static final Block block = null;
	public PearlWoodBlock(TerariamodModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pearl_wood");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PearlWoodBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PearlWoodBlock.block, (int) (1)));
		}
	}
}
